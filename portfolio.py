        ...
        with col1:
            ...
            st.markdown(
                ...
                <div style='display: flex;'>
                    ...
                    <a style='display: inline-flex; margin-right: 5px; align-items: center; padding: 10px 20px; background-color: #FF4B4B; color: white; text-decoration: none; border-radius: 5px;' href="https://drive.google.com/file/d/1-eDl0H5lEq5D7y3GKwb5YWzlpaMruOyw/view?usp=drive_link" target="_blank">
